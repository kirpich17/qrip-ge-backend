...
const PromoCodeSchema = new mongoose.Schema(
  {
    ...
    // Keep these optional fields for future flexibility if needed,
    // though the current client request implies global codes.
    appliesToPlan: {
...
PromoCodeSchema.methods.isValid = function () {
  ...
  const hasUsagesLeft = this.maxUsage === null || this.currentUsage < this.maxUsage;
