...
router.post('/', isAuthenticated, isUser, upload.single('profileImage'), createMemorial);
router.put('/:id', isAuthenticated, isUser, upload.single('profileImage'), updateMemorial);
...
router.post('/:id/video', isAuthenticated, isUser,upload.single('video'), addVideoToMemorial);
