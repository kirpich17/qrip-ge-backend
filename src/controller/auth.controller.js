...
exports.signup = async (req, res) => {
  try {
    ...
    const user = await User.create({ firstname, lastname, email, password: hash, userType });
...
exports.signin = async (req, res) => {
  try {
    ...
    if (!valid) return res.status(400).json({ status: false, message: 'Invalid credentials' });
